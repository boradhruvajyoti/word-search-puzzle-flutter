// Logic: Word bank — English dictionary categories (Clean & Family-Friendly)
class WordBank {
  // ── English Categories ───────────────────────────────────────────────────
  static const Map<String, List<String>> categories = {
    'animals': [
      'ANT','APE','FOX','BAT','BEE','BOA','BUG','CAT','COD','COW','CUB',
      'DAM','DOE','DOG','EMU','EWE','FLY','GNU','HEN','JAY','KOI','OX',
      'PIG','PUP','RAM','RAT','YAK','EEL','ELK',
      'BEAR','BIRD','BUCK','BULL','CALF','CARP','CLAM','COLT','CRAB','CROW',
      'DART','DEER','DODO','DOVE','DUCK','SEAL','FAWN','FILLY','FISH',
      ...
      'MACAW','MOOSE','MOTH','MOUSE','OKAPI','OTTER','PANDA','QUAIL','RAVEN',
      ...
      'PARROT','PIGEON','PLOVER','PUFFIN','PYTHON','RABBIT','RACCOON','SALMON',
      'SERVAL','SHRIMP','SPIDER','THRUSH','TOUCAN','TURKEY','TURTLE','WALRUS','WOMBAT',
    ...
    'birds': [
      ...
      'OSPREY','PARROT','PETREL','PIGEON','PUFFIN','EAGLE',
      ...
      'SPARROW','SWALLOW','TANAGER','VULTURE','WAXWING','WOODPECKER',
    ],
    'fruits': [
      ...
      'POMELO','PAPAW',
      'CURRANT','DAMSONS','PERSIMMON','MANGOSTEEN','NECTARINE','PASSION','TANGELO',
      'BLUEBERRY','CRANBERRY','DATEPALM','FIGTREE','GOOSEBERRY','GRAPEFRUIT',
      'CANTALOUPE','KIWIFRUIT','MULBERRY','PINEAPPLE','RASPBERRY','STARFRUIT',
      'STRAWBERRY','TANGERINE','WATERMELON',
    ],
    'vegetables': [
      'YAM','KALE','PEA','LEEK',
      'BEAN','BEET','CORN','OKRA','ONION','TARO',
      'CARROT','CELERY','CHILI','CHIVE','GARLIC','GINGER','POTATO','RADISH',
      'SQUASH','TURNIP',
      'BAMBOO','ARUGULA','ENDIVE','FENNEL','JALAPENO','LENTIL','PARSNIP',
      'PEPPER','CASSAVA','RADICCHIO','TOMATO','ZUCCHINI',
    ...
    'countries': [
      'CHAD','CUBA','FIJI','IRAN','IRAQ','LAOS','MALI','YEMEN','OMAN','PERU','TOGO',
      ...
      'UKRAINE','VIETNAM',
      'ALBANIA','BAHAMAS','BULGARIA','CAMBODIA','COLOMBIA','DOMINICA','HONDURAS','BAHRAIN',
    ...
    'science': [
      ...
      'OXYGEN','PLASMA','PROTON','PROBE','QUARK','RADAR','TISSUE',

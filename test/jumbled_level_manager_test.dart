...
void main() {
  group('JumbledLevelManager Tests', () {
    test('Generates valid config for Level 1 in English', () {
      final config = JumbledLevelManager.configForLevel(1);
    ...
    test('Generates config for 1,000 levels', () {
      final configLevel1 = JumbledLevelManager.configForLevel(1);
      final configLevel500 = JumbledLevelManager.configForLevel(500);
      final configLevel1000 = JumbledLevelManager.configForLevel(1000);
